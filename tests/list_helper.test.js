...
describe('total likes', () => {
    ...
    test('zero blogs should return 0', () => {
...
describe('favourite blog', () => {
    ...
    test('when list has multiple blog return blog with most likes', () => {
    ...
    test('when list has multiple blog with same max likes return either', () => {
        const result = listHelper.favouriteBlog(blogsWithSameMaxLikes)
        expect(result).toEqual({
            title: "Go To Statement Considered Harmful",
            author: "Edsger W. Dijkstra",
            likes: 12,
...
describe('most blogs', () => {
    ...
    test('equal number of blogs', () => {
        const result = listHelper.mostBlogs(blogsWithEqualNumber)
        expect(result).toEqual({
            author: "Michael Chan",
            blogs: 1
        })
...
describe('most likes', () => {
    ...
    test('likes with equal number', () => {
        const result = listHelper.mostLikes(likesWithEqualNumber)
        expect(result).toEqual({
            author: 'Michael Chan',
            likes: 7
        })
